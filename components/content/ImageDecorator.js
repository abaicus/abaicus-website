export default function ImageDecorator({ overlay = false }) {
    if (!overlay) {
        return (
            <>
                <div className="absolute pointer-events-none w-[250px] h-[250px] -right-5 -bottom-5 mix-blend-multiply bg-sky-400 rounded-lg shadow-lg shadow-sky-200 transition-all 
    ...
    dark:mix-blend-hard-light dark:shadow-none dark:opacity-75"/>
                ...
                <div className="absolute pointer-events-none w-[150px] h-[150px] -left-5 -top-5 mix-blend-multiply bg-red-500 rounded-lg shadow-lg shadow-red-200 transition-all
